...
export default function Minimap({ className: customClassName }) {
  return (
    <nav
      className={
        "flex flex-wrap justify-center gap-1 text-sm text-zinc-400 select-none *:rounded-3xl *:px-3 *:py-2 *:transition-colors *:hover:bg-zinc-800 *:hover:text-zinc-200 *:focus-visible:bg-zinc-700 *:focus-visible:text-zinc-100 *:active:bg-zinc-700 *:active:text-zinc-100" +
