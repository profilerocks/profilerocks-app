...
export default function Settingss() {
  ...
  return (
    <>
      <nav className="z-1 flex overflow-auto border-be border-zinc-700 text-zinc-400 shadow-lg shadow-black select-none *:flex *:min-w-max *:gap-1.5 *:p-2.5 *:transition-colors *:hover:text-zinc-200 *:active:text-zinc-100 lg:mbs-4 lg:flex-col lg:border-be-0 lg:text-2xl lg:*:gap-3.5">
